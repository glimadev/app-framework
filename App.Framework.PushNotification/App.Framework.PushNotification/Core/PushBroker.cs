...
namespace App.Framework.PushNotification.Core
{
	public class PushBroker : IPushBroker
	{
        ...
        public ResultPush resultPush { get; set; }
		...
		public void QueueNotification<TPushNotification>(TPushNotification notification) where TPushNotification : Notification
		{
			...
			foreach (var s in services)
				s.QueueNotification (notification, resultPush);
		}
		...
		public IEnumerable<IPusherService> GetAllRegistrations()
		{
			lock (serviceRegistrationsLock)
		...
		/// <returns>The registered services</returns>
		/// <typeparam name="TNotification">Type of notification</typeparam>
		public IEnumerable<IPusherService> GetRegistrations<TNotification>()
		{
			return GetRegistrations<TNotification> (null);
		}

		public IEnumerable<IPusherService> GetRegistrations(string applicationId)
		{
			lock (serviceRegistrationsLock)
		...
		/// <param name="applicationId">Application identifier </param>
		/// <typeparam name="TNotification">Type of notification</typeparam>
		public IEnumerable<IPusherService> GetRegistrations<TNotification>(string applicationId)
		{
