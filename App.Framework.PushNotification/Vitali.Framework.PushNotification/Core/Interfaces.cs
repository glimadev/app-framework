...
namespace Vitali.Framework.PushNotification.Core
{
	...
	public interface IPusherService : IDisposable
	{
		...
		bool IsStopping { get; }
		void QueueNotification(INotification notification, ResultPush resultPush);
    ...
    public interface IPushBroker : IDisposable
    {
        ...
        void RegisterService<TPushNotification>(IPusherService pushService, string applicationId, bool raiseErrorOnDuplicateRegistrations = true) where TPushNotification : Notification;
        ...
        /// <param name="raiseErrorOnDuplicateRegistrations">If set to <c>true</c> raises an error if there is an existing registration for the given notification type.</param>
        /// <typeparam name="TPushNotification">Type of notifications to register the service for</typeparam>
        void RegisterService<TPushNotification>(IPusherService pushService, bool raiseErrorOnDuplicateRegistrations = true) where TPushNotification : Notification;
        ...
        IEnumerable<IPusherService> GetAllRegistrations();
        ...
        /// <returns>The registered services</returns>
        /// <typeparam name="TNotification">Type of notification</typeparam>
        IEnumerable<IPusherService> GetRegistrations<TNotification>();

        IEnumerable<IPusherService> GetRegistrations(string applicationId);
        ...
        /// <param name="applicationId">Application identifier </param>
        /// <typeparam name="TNotification">Type of notification</typeparam>
        IEnumerable<IPusherService> GetRegistrations<TNotification>(string applicationId);
