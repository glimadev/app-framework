...
namespace App.Framework.Xml
{
        ...
        where T : class, new()
    {
        ...
        public static string Serialize(T source, bool idented = false)
        {
            if (idented)
            {
            ...
            {
                // not idented XML
                return Serialize(source, null, GetNotIndentedSettings());
            }
        }
        ...
        private static XmlWriterSettings GetNotIndentedSettings()
        {
            XmlWriterSettings xmlWriterSettings = new XmlWriterSettings();
